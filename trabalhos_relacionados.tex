...
\textbf{DÚVIDA: Vale a pena fazer a tabela abaixo? Não sei que dados são relevantes para comparação neste momento, sem experimentos no meu trabalho}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Algoritmo} & \textbf{Características} & \textbf{Técnicas} \\ \hline
