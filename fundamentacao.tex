...
\begin{itemize}
	...
	\item \textbf{Problemas de regressão}: quando a saída esperada para o problema é um valor numérico, normalmente contínuo.
\end{itemize}
...
%TODO falar de árvores de decisão
%TODO falar de KNN
%TODO falar de SVM
%TODO falar de essembles (random forests)
...
Tanto durante o desenvolvimento de uma solução, quanto após sua execução em ambiente de produção, é preciso aferir ou quantificar o desempenho da técnica desenvolvida ou utilizada.
