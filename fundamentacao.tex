...
\begin{table}[h]
  \begin{tabular}{cccc}
  \multicolumn{2}{c}{\textbf{Resultado obtido}}                 &          &                                              \\
  \multicolumn{1}{c|}{Classe A} & \multicolumn{1}{c|}{Classe B} &          &                                              \\ \cline{1-3}
  \multicolumn{1}{c|}{TP}       & \multicolumn{1}{c|}{FN}       & Classe A & \multirow{2}{*}{\textbf{Resultado esperado}} \\ \cline{1-3}
  \multicolumn{1}{c|}{FP}       & \multicolumn{1}{c|}{TN}       & Classe B &
  \end{tabular}
