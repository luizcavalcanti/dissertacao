...
Considerando esse cenário, é válido afirmar que o conjunto de classificadores unários é a abordagem mais promissora dentre as avaliadas para resolver o problema da detecção de elementos antrópicos em imagens aéreas da floresta amazônica. Mesmo que o algoritmo KNN em uma abordagem multi-classe tenha se saído sensivelmente melhor nos experimentos deste trabalho, é esperado que este modelo de aprendizado obtenha pior desempenho em conjuntos de imagens com novos tipos de elementos antrópicos.
