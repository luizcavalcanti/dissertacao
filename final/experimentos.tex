...
Alguns segmentos não puderam ser classificados e foram descartados das bases de treinamento e validação, todos os elementos antrópicos encontrados foram validados por uma especialista do Sistema de Proteção da Amazônia (SIPAM), órgão governamental que é responsável pelo patrulhamento e sensoriamento remoto da Amazônia legal brasileira.
...
%TODO tabela de detalhes dos atributos
...
%TODO falar dos problemas da base desbalanceada e do que foi feiro para resolver
