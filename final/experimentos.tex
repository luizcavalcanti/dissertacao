...
MSEG        & 0.01005 & $\pm 0.01429$ & 0.00072 & $\pm 0.01429$ & \cellcolor{gray!25}0,33 \\ \hline
SRM         & \cellcolor{gray!25}0.00622 & \cellcolor{gray!25}$\pm 0.00822$ & \cellcolor{gray!25}0.00066 & \cellcolor{gray!25}$\pm 0.00999$ & 4,66 \\ \hline
\end{tabulary}
...
Com um tempo de processamento baixo e excelentes resultados nas métricas de erro local e global, o algoritmo SRM foi escolhido como método para determinar os segmentos de imagem a servir de entrada para a próxima etapa da solução, responsável pela classificações destes mesmos segmentos.
...
\multirow{3}{*}{Floresta} & Intensidade - histograma (5/15) & Inteiro & 7x1 \\ \cline{2-4}
                          & LBP - histograma (1/26)         & Inteiro & 1x1 \\ \cline{2-4}
                          & Hough - maior reta              & Inteiro & 1x1 \\ \hline \hline
\multirow{3}{*}{Água}     & Intensidade - histograma (7/15) & Inteiro & 7x1 \\ \cline{2-4}
                          & LBP - histograma (2/26)         & Inteiro & 2x1 \\ \cline{2-4}
                          & Hough - número de retas         & Inteiro & 1x1 \\ \hline \hline
\multirow{3}{*}{Vegetação}& Intensidade - histograma (6/15) & Inteiro & 7x1 \\ \cline{2-4}
                          & LBP - histograma (1/26)         & Inteiro & 1x1 \\ \cline{2-4}
                          & Hough - número de retas         & Inteiro & 1x1 \\ \hline \hline
\multirow{4}{*}{Terra}    & Intensidade - histograma (7/15) & Inteiro & 7x1 \\ \cline{2-4}
                          & LBP - histograma (1/26)         & Inteiro & 1x1 \\ \cline{2-4}
                          & Hough - número de retas         & Inteiro & 1x1 \\ \cline{2-4}
                          & Hough - maior reta              & Inteiro & 1x1 \\ \hline
\end{tabulary}
\caption{Atributos selecionados pela técnica de CFS para a abordagem de classificação unária.}
...
OC-SVM  & OC-SVM (CFS)  & REPTree & OCSVM   & \cellcolor{gray!25}0.947 & 0.692 & \cellcolor{gray!25}0.800 \\ \hline
...
OC-SVM  & OC-SVM        & REPTree       & OC-SVM        & 0.156 & \cellcolor{gray!25}0.769 & 0.259 \\ \hline
