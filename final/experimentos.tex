...
Como forma de utilizar um conjunto de classificadores unários para resolver um problema de classificação multi-classe, o método desenvolvido por \citeonline{hadjadji:2014} foi utilizado. Este método permite não só que diferentes classificadores unários sejam utilizados para alcançar uma classificação final, mas também possibilita que o peso de cada classificador mude de acordo com a amostra, com o objetivo de reduzir o viés para determinadas classes.
...
\begin{tabulary}{\linewidth}{|L|R|R|R|R|}
\hline
 & \textbf{Acurácia} & \textbf{Precisão} & \textbf{Revocação} & \textbf{F1} & \textbf{F1} \\ \hline
...
REP-SVM-SVM-REP & \cellcolor{gray!25}0.666 & 0.769 & \cellcolor{gray!25}0.714 \\ \hline
SVM-SVM-SVM-REP & 0.096 & \cellcolor{gray!25}0.923 & 0.175 \\ \hline
