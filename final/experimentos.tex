...
\todo[inline]{Adicionar uma imagem para demonstrar diferenças de granularidade?}
...
\todo[inline]{falar dos problemas da base desbalanceada e do que foi feito para resolver}
...
\centering
	\begin{tabulary}{\linewidth}{|L|R|R|R|}
		...
		Random Forest     & 0.440 & \cellcolor{gray!25}0.846 & 0.914 \\ \hline
	\end{tabulary}
