...
\textbf{Lugar certo? Talvez deva estar junto às métricas de avaliação de machine learning, na seção de fundamentação teórica, subseção de avaliação}
...
%TODO Começar conforme abaixo
% os resultados deste experimento foram gerados a partir da comparação com X imagens de segmentação humana bla bla bla...

%TODO mostrar que a segmentação humana é consistente
%TODO mostrar resultado de benchmark
