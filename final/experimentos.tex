...
%TODO fazer bruteforce para encontar melhores métodos
...
\todo[inline]{Discutir sobre parametrização dos métodos?}
...
\centering
	\begin{tabulary}{\linewidth}{|L|R|R|R|}
		...
		Naive Bayes       & \cellcolor{gray!25}0.840 & 0.026 & \cellcolor{gray!25}0.975 \\ \hline
		KNN (3)           & 0.600 & 0.750 & 0.824 \\ \hline
		Random Forest     & 0.500 & \cellcolor{gray!25}0.846 & 0.949 \\ \hline
...
\todo[inline]{Falar sobre algoritmo com melhor revocação e área ROC}
