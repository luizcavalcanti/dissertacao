...
Cada vetor de características em cada pixel é tratado como uma combinação linear de características, e que possuem a capacidade de identificar bordas entre os segmentos da imagem. Digamos que $Y$, a representação $M \times N$ de uma imagem e $L$ é o número de características representativas, podemos expressar a imagem $Y$ por:
