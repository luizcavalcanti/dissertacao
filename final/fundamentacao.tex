...
Dentre as técnicas de inspiração probabilística, se destaca por sua simplicidade a \textit{Naive Bayes}. Esta família de algoritmos presume uma forte independência entre as variáveis do vetor de características, por isso é considerada uma técnica ingênua (do inglês \textit{Naive}).
