...
A transformada de Hough, introduzida por \citeonline{hough:1962} é uma técnica criada para extrair formas geométricas de imagens. O objetivo desta técnica está na descrição da imagem ou região através de retas, círculos e elipses presentes na mesma. Inicialmente concebida para detectar apenas linhas em diversos ângulos, atualmente todas as implementações e variações da transformada Hough derivam do trabalho de \citeonline{duda:1972}, responsável pela criação da transformada de Hough generalizada, capaz de detectar os demais círculos e elipses. Desde então, diversas melhorias têm sido feitas para acelerar o algoritmo, bem como suportar a detecção de formas geométricas arbitrárias.
