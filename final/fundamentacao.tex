...
O trabalho de \citeonline{hadjadji:2014}, por exemplo, apresenta um modelo para conjuntos de classificadores de anomalias em que diversos algoritmos e estratégias diferentes podem ser utilizados em conjunto para solucionar um mesmo problema de aprendizagem. Isto possibilita um grau de liberdade elevado na escolha desses algoritmos e estratégias para problemas multi-classe.
