...
\begin{frame}[c]
	...
	\small{
		...
		\multirow{3}{*}{Floresta} & Intensidade - histograma (5/15) & 7x1 \\ \cline{2-3}
        		                  & LBP - histograma (1/26)         & 1x1 \\ \cline{2-3}
                			          & Hough - maior reta              & 1x1 \\ \hline \hline
		\multirow{3}{*}{Água}     & Intensidade - histograma (7/15) & 7x1 \\ \cline{2-3}
        		                  & LBP - histograma (2/26)         & 2x1 \\ \cline{2-3}
	                		          & Hough - número de retas         & 1x1 \\ \hline \hline
		\multirow{3}{*}{Vegetação}& Intensidade - histograma (6/15) & 7x1 \\ \cline{2-3}
        		                  & LBP - histograma (1/26)         & 1x1 \\ \cline{2-3}
                			          & Hough - número de retas         & 1x1 \\ \hline \hline
		\multirow{4}{*}{Terra}    & Intensidade - histograma (7/15) & 7x1 \\ \cline{2-3}
        		                  & LBP - histograma (1/26)         & 1x1 \\ \cline{2-3}
                		        		  & Hough - número de retas         & 1x1 \\ \cline{2-3}
